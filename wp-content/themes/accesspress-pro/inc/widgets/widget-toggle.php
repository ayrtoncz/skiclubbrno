...
function register_toggle_widget() {
    register_widget('accesspress_pro_toggle');
}

class Accesspress_Pro_Toggle extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'accesspress_pro_accordion', 'AP : Toggle', array(
            'description' => __('A widget that shows Toggle', 'accesspress-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        ...
        $fields = array(
            ...
            // Other fields
            'toggle_title' => array(
                'accesspress_pro_widgets_name' => 'toggle_title',
                'accesspress_pro_widgets_title' => __('Toggle Title', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'textarea',
                'accesspress_pro_widgets_row' => '3'
            ),
            'toggle_content' => array(
                'accesspress_pro_widgets_name' => 'toggle_content',
                'accesspress_pro_widgets_title' => __('Toggle Content', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'textarea',
                'accesspress_pro_widgets_row' => '6'
            ),
            'toggle_status' => array(
                'accesspress_pro_widgets_name' => 'toggle_status',
                'accesspress_pro_widgets_title' => __('Toggle Status', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'select',
                'accesspress_pro_widgets_field_options' => $status
            )
        );
