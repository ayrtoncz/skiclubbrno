...
class Accesspress_Pro_Preview_Post extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'accesspress_pro_preview_post', 'AP : Preview Post', array(
            'description' => __('A widget that shows post/page preview', 'accesspress-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'post_id' => array(
                ...
                'accesspress_pro_widgets_title' => __('Post', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'selectpost',
            ),
            'display_title' => array(
                'accesspress_pro_widgets_name' => 'display_title',
                'accesspress_pro_widgets_title' => __('Show post title', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'checkbox'
            ),
            'display_thumbnail' => array(
                'accesspress_pro_widgets_name' => 'display_thumbnail',
                'accesspress_pro_widgets_title' => __('Show featured image', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'checkbox'
            ),
            'display_excerpt' => array(
                'accesspress_pro_widgets_name' => 'display_excerpt',
                'accesspress_pro_widgets_title' => __('Show excerpt', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'checkbox'
            ),
            'read_more_text' => array(
                'accesspress_pro_widgets_name' => 'read_more_text',
                'accesspress_pro_widgets_title' => __('Read more link text', 'accesspress-pro'),
                'accesspress_pro_widgets_description' => __('Leave empty for no link', 'accesspress-pro'),
