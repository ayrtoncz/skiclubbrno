...
class Accesspress_Pro_Flickr_Stream extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'accesspress_pro_flickr_stream', 'AP : Flickr Stream', array(
            'description' => __('Displays your Flickr photos.', 'accesspress-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'flickr_id' => array(
                ...
                'accesspress_pro_widgets_title' => __('Flickr ID', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'text'
            ),
            'photo_count' => array(
                'accesspress_pro_widgets_name' => 'photo_count',
                'accesspress_pro_widgets_title' => __('Number of Photos', 'accesspress-pro'),
            ...
            'photo_type' => array(
                ...
                'accesspress_pro_widgets_title' => __('Type (user or group)', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'select',
                'accesspress_pro_widgets_field_options' => array(
                    'user' => 'User',
                    'group' => 'Group'
            ...
            'photo_display' => array(
                ...
                'accesspress_pro_widgets_title' => __('Display', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'select',
                'accesspress_pro_widgets_field_options' => array(
                    'latest' => 'Latest',
                    'random' => 'Random'
