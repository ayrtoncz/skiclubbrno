...
class Accesspress_Pro_Media_Embed extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'accesspress_pro_media_embed', 'AP : Media Embed', array(
            'description' => __('Display media (video/slideshow) widget, support many sites including YouTube, Vimeo, Flickr, etc.', 'accesspress-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'embed_url' => array(
                ...
                'accesspress_pro_widgets_title' => __('Embed URL', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'text'
            ),
            'embed_width' => array(
                'accesspress_pro_widgets_name' => 'embed_width',
                'accesspress_pro_widgets_title' => __('Embed width in pixels', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'number'
            ),
            'embed_description' => array(
                'accesspress_pro_widgets_name' => 'embed_description',
                'accesspress_pro_widgets_title' => __('Description', 'accesspress-pro'),
