...
<section class="error-404 not-found">
	...
	<header class="entry-header">
		...
		<h1 class="entry-title ak-container"><?php _e( 'Oops! That page can&rsquo;t be found.', 'accesspress-pro' ); ?></h1>
		</header><!-- .entry-header -->

		<div class="ak-container">
			<div class="page-content">
				<p><?php _e( 'It looks like nothing was found at this location.', 'accesspress-pro' ); ?></p>
			</div><!-- .page-content -->
