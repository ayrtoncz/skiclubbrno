...
class Accesspress_Image extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            'description' => __('A widget that upload image', 'accesspress-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            'image_title' => array(
                'accesspress_pro_widgets_name' => 'image_title',
                'accesspress_pro_widgets_title' => __('Title', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'text',
            ),
            'image_size' => array(
                'accesspress_pro_widgets_name' => 'image_size',
                'accesspress_pro_widgets_title' => __('Image Size', 'accesspress-pro'),
            ...
            'image_align' => array(
                'accesspress_pro_widgets_name' => 'image_align',
                'accesspress_pro_widgets_title' => __('Image Align', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'select',
                'accesspress_pro_widgets_field_options' => array(
                    'ap-align-none' => 'None',
                    'ap-align-left' => 'Left',
