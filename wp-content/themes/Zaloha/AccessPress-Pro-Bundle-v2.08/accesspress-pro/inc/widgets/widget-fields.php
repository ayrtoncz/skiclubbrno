...
function accesspress_pro_widgets_show_widget_field($instance = '', $widget_field = '', $athm_field_value = '') {
    ...
    switch ($accesspress_pro_widgets_field_type) {
        ...
        case 'textarea' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($accesspress_pro_widgets_name); ?>"><?php echo $accesspress_pro_widgets_title; ?>:</label>
                <textarea class="widefat" rows="<?php echo $accesspress_pro_widgets_row; ?>" id="<?php echo $instance->get_field_id($accesspress_pro_widgets_name); ?>" name="<?php echo $instance->get_field_name($accesspress_pro_widgets_name); ?>"><?php echo $athm_field_value; ?></textarea>
            </p>
            <?php if (isset($accesspress_pro_widgets_description)) { ?>
                    <small><?php echo $accesspress_pro_widgets_description; ?></small>
            <?php } ?>
        ...
        case 'select' :
            ...
            <p>
                ...
                <select name="<?php echo $instance->get_field_name($accesspress_pro_widgets_name); ?>" id="<?php echo $instance->get_field_id($accesspress_pro_widgets_name); ?>" class="widefat">
                    <?php foreach ($accesspress_pro_widgets_field_options as $athm_option_name => $athm_option_title) { ?>
        ...
        case 'selectpost' :
            ...
            <p>
                <label for="<?php echo $instance->get_field_id($accesspress_pro_widgets_name); ?>"><?php echo $accesspress_pro_widgets_title; ?>:</label>
                <select name="<?php echo $instance->get_field_name($accesspress_pro_widgets_name); ?>" id="<?php echo $instance->get_field_id($accesspress_pro_widgets_name); ?>" class="widefat">
                    <?php foreach ($accesspress_pro_postlist as $accesspress_pro_single_post) { ?>
        ...
        case 'upload' :
            ...
            $output = '';
            $id = $instance->get_field_id($accesspress_pro_widgets_name);
            $class = '';
            $int = '';
            $value = $athm_field_value;
            $name = $instance->get_field_name($accesspress_pro_widgets_name);
            ...
            $output .= '<label for="' . $instance->get_field_id($accesspress_pro_widgets_name) . '">' . $accesspress_pro_widgets_title . '</label><br/>';
        ...
        case 'icon' :
            ...
            <p>
                ...
                <input class="hidden-icon-input" name="<?php echo $instance->get_field_name($accesspress_pro_widgets_name); ?>" type="hidden" id="<?php echo $instance->get_field_id($accesspress_pro_widgets_name); ?>" value="<?php echo $athm_field_value; ?>" />
...
function accesspress_pro_widgets_updated_field_value($widget_field, $new_field_value) {
    ...
    if ($accesspress_pro_widgets_field_type == 'number') {
        ...
        if (!isset($accesspress_pro_widgets_allowed_tags)) {
            ...
            $accesspress_pro_widgets_allowed_tags = '<p><strong><em><a><li>';
        }
        return strip_tags($new_field_value, $accesspress_pro_widgets_allowed_tags);

        // No allowed tags for all other fields
    } elseif ($accesspress_pro_widgets_field_type == 'url') {
...
function optionsframework_media_scriptss($hook) {
    ...
    wp_enqueue_script('of-media-uploader', get_template_directory_uri() . '/inc/admin-panel/js/media-uploader1.js', array('jquery'),'1.0');
    ...
    wp_enqueue_style('ap-admin-css', get_template_directory_uri() . '/inc/admin-panel/css/ap-admin.css');
    wp_enqueue_script('ap-admin-js', get_template_directory_uri() . '/inc/admin-panel/js/ap-admin.js', array('jquery'));
}
