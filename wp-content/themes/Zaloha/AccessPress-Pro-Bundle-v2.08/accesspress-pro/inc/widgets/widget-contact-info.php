...
class Accesspress_Contact_Info extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
                'accesspress_contact_info', 'AP : Contact Info', array(
            'description' => __('A widget that shows Contact Info', 'accesspress-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            'contact_info_title' => array(
                'accesspress_pro_widgets_name' => 'contact_info_title',
                'accesspress_pro_widgets_title' => __('Title', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'text',
            ),
            'contact_info_phone' => array(
                'accesspress_pro_widgets_name' => 'contact_info_phone',
                'accesspress_pro_widgets_title' => __('Phone', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'text',
            ),
            'contact_info_email' => array(
                'accesspress_pro_widgets_name' => 'contact_info_email',
                'accesspress_pro_widgets_title' => __('Email', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'text',
            ),
            'contact_info_website' => array(
                'accesspress_pro_widgets_name' => 'contact_info_website',
                'accesspress_pro_widgets_title' => __('Website', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'text',
            ),
            'contact_info_address' => array(
                'accesspress_pro_widgets_name' => 'contact_info_address',
                'accesspress_pro_widgets_title' => __('Contact Address', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'textarea',
                'accesspress_pro_widgets_row' => '4'
            ),
            'contact_info_time' => array(
                'accesspress_pro_widgets_name' => 'contact_info_time',
                'accesspress_pro_widgets_title' => __('Contact Time', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'textarea',
                'accesspress_pro_widgets_row' => '3'
            ),
        );
