...
class Facebook_Like_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            'description' => __('A widget that shows Facebook Like Box', 'accesspress-pro')
                )
        );
    }
    ...
    private function widget_fields() {
        $fields = array(
            ...
            'facebook_like_title' => array(
                'accesspress_pro_widgets_name' => 'facebook_like_title',
            ...
            'facebook_like_page_url' => array(
                'accesspress_pro_widgets_name' => 'facebook_like_page_url',
                'accesspress_pro_widgets_title' => __('Facebook Page URL', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'url',
            ),
            'facebook_like_width' => array(
                'accesspress_pro_widgets_name' => 'facebook_like_width',
                'accesspress_pro_widgets_title' => __('Width', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'number',
            ),
            'facebook_like_height' => array(
                'accesspress_pro_widgets_name' => 'facebook_like_height',
                'accesspress_pro_widgets_title' => __('Height', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'number',
            ),
            'facebook_small_header' => array(
                'accesspress_pro_widgets_name' => 'facebook_small_header',
                'accesspress_pro_widgets_title' => __('Use Small Header', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'checkbox'
            ),
            'facebook_show_face' => array(
                'accesspress_pro_widgets_name' => 'facebook_show_face',
                'accesspress_pro_widgets_title' => __('Show Friend Faces', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'checkbox'
            ),
            'facebook_tabs' => array(
                'accesspress_pro_widgets_name' => 'facebook_tabs',
                'accesspress_pro_widgets_title' => __('Tabs to render', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'title'
            ),
            'facebook_tab_timeline' => array(
                'accesspress_pro_widgets_name' => 'facebook_tab_timeline',
                'accesspress_pro_widgets_title' => __('Timeline', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'checkbox'
            ),
            'facebook_tab_message' => array(
                'accesspress_pro_widgets_name' => 'facebook_tab_message',
                'accesspress_pro_widgets_title' => __('Message', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'checkbox'
            ),
            'facebook_tab_events' => array(
                'accesspress_pro_widgets_name' => 'facebook_tab_events',
                'accesspress_pro_widgets_title' => __('Events', 'accesspress-pro'),
                'accesspress_pro_widgets_field_type' => 'checkbox'
            ),
        );
