				...
				<?php
					...
					while ($query4->have_posts()) : $query4->the_post();
						...
						<div class="featured-content">
							<p><?php echo accesspress_pro_excerpt( get_the_content() , $accesspress_pro_featured_post_char ) ?></p>
							<?php if(!empty($accesspress_pro_featured_post_readmore)): ?>
							<a href="/category/akce/" class="read-more bttn"><?php echo $accesspress_pro_featured_post_readmore; ?></a>
							<?php endif; ?>
						</div>
					<?php endwhile;
					wp_reset_postdata(); ?>
					...
					<?php
						...
						while ($query4->have_posts()) : $query4->the_post();
							...
							<div class="featured-content">
								<p><?php echo accesspress_pro_excerpt( get_the_content() , $accesspress_pro_featured_post_char ) ?></p>
								<?php if(!empty($accesspress_pro_featured_post_readmore)): ?>
								<a href="/category/aktuality/" class="read-more bttn"><?php echo $accesspress_pro_featured_post_readmore; ?></a>
								<?php endif; ?>
							</div>
						<?php endwhile;
						wp_reset_postdata(); ?>
